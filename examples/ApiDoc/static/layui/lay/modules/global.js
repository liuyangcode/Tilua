        ...
        ;!function(){
            ...
            if(elemParter[0] && !notParter){
                var tipsIndex = layer.tips(
                    ['<a href="https://fly.layui.com/jump/alyhot/" target="_blank" id="layui-spm-event-parter-tips" style="display: block; line-height: 30px; padding: 10px; text-align: center; font-size: 14px; background-image: linear-gradient(to right,#8510FF,#D025C2,#FF8B2D,#F64E2C); color: #fff;">'

                        //腾讯618：background-image: linear-gradient(to right,#1242A4,#1746A1,#CFAE71,#1746A1);
                        //华为618：background-image: linear-gradient(to right,#8109BF,#E22B6A,#E76F68,#EBC17F);
